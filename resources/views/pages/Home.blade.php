              ...
              <div class="rated_lawyers grid w-full">
                ...
                <x-card class=" m-0">
                    <div class="card_head flex w-full ">
                        ...
                        <div class="card_head_info w-3/5 pl-5">
                            <a href="" class=" text-xl capitalize text-blue-600 font-semibold">Lawyers Name</a>
                ...
                <x-card class=" m-0">
                    <div class="card_head flex w-full ">
                        ...
                        <div class="card_head_info w-3/5 pl-5">
                            <a href="" class=" text-xl capitalize text-blue-600 font-semibold">Lawyer Name</a>
                            <ul class=" text-lg mb-1 text-emerald-800 font-light py-1">Practice Area:
                              <li class=" text-sm pl-3 mb-1 capitalize">
                                Commercial
                              </li>
                ...
                <x-card class=" !m-0">
                    <div class="card_head flex w-full ">
                        <div class="card_image w-48 h-52 rounded-lg overflow-hidden">
                            <img class="w-full h-full rounded-lg max-w-xs transition duration-300 ease-in-out hover:scale-110" src="{{ asset('assets/images/lawyers.jpg') }}"
                                alt="">
                        </div>
                        <div class="card_head_info w-3/5 pl-5">
                            <a href="" class=" text-xl capitalize text-blue-600 font-semibold">Lawyer Name</a>
